...
"2- Quiero solicitar sus servicios\n"+
...
const opcionPrecio = new Nodo(
  "Precio",
`Medusa es una solución personalizada, que se adapta a las necesidades y presupuesto de tu empresa. Es por esto que el precio será diferente cada caso. Enviamos tu consulta a un representante para que se contacte con usted por una cotización a la brevedad.`,
  "4",
  true,
  "admin",
  true,
...
const opcionDerivadoTecnico = new Nodo(
  "derivadoTecnico",
  `Derivé tu consulta al departamento tecnico. Nos comunicaremos contigo a la brevedad. Saludos!`,
  "3",
  true,
  "tecnico",
  true,
...
const opcionDerivadoServicio = new Nodo(
  "derivadoServicio",
  `Derivé tu consulta al departamento de ventas. Nos comunicaremos contigo a la brevedad. Saludos!`,
  "2",
  true,
  "ventas",
  true,
...
const opcionDerivadoServicio2 = new Nodo(
...
arbolRespuestas.addOpcion(opcionDerivadoTecnico); // Opción 2: deriva a operador
arbolRespuestas.addOpcion(opcionDerivadoServicio)
// opcionOperador.addOpcion(opcionDerivadoTecnico); // Opción 1: derivadoTecnico
// opcionOperador.addOpcion(); // Opción 2: opcionDerivadoServicio


opcionRuvik.addOpcion(opcionOcurreSolicitarRepre); //opcion 1: opcionOcurreSolicitarRepre
opcionRuvik.addOpcion(opcionDerivadoServicio2); //opcion 2: Demostracion
opcionRuvik.addOpcion(opcionInstalaUtiliza); //opcion 3: opcionInstalaUtiliza
opcionRuvik.addOpcion(opcionPrecio); //opcion 4: opcionPrecio
